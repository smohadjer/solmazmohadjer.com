...
define('TARGET_DIR', '/var/www/vhosts/saeidmohadjer.com/solmaz.saeidmohadjer.com/');
...
define('TMP_DIR', '/var/www/vhosts/saeidmohadjer.com/solmaz.saeidmohadjer.com/tmp/spgd-'.md5(REMOTE_REPOSITORY).'/');
